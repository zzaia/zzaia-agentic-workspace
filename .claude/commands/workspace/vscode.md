...
sequenceDiagram
    ...
    U->>C: /workspace:vscode --action <setup|validate|update> [options]
...
```
/workspace:vscode --action setup
/workspace:vscode --action setup --mode project --repo order-service
/workspace:vscode --action validate
/workspace:vscode --action update --repo order-service --branch feature/checkout
```
