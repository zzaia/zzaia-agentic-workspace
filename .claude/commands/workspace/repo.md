...
sequenceDiagram
    ...
    U->>C: /workspace:repo --action new --repo <repo> [--branch <branch>]
...
```
/workspace:repo --action new --repo https://github.com/username/repository.git
/workspace:repo --action new --repo https://github.com/username/repo1.git https://github.com/username/repo2.git
/workspace:repo --action new --repo my-api --branch feature/user-authentication
/workspace:repo --action new --repo frontend --branch bugfix/header-styling --target-branch develop
```
