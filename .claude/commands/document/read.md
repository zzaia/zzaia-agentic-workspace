...
2. **Extract Content**: Run `.claude/hooks/extract-document.py` to parse document
...
```
/document:read --file ~/projects/report.pdf
/document:read --file ./contract.docx
/document:read --file /absolute/path/document.pdf --summary
```
