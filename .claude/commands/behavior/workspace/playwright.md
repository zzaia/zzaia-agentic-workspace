...
sequenceDiagram
    ...
    U->>C: /behavior:workspace:playwright --action debug [--url <url>]
...
```
/behavior:workspace:playwright --action debug
/behavior:workspace:playwright --action debug --url https://localhost:3000/dashboard
```
