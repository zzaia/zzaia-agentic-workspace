...
sequenceDiagram
    ...
    U->>C: /behavior:workspace:postman --action <action> [--target <type>] [--id <id>] [--spec <payload>]
...
```
/behavior:workspace:postman --action request --spec "--method GET --url https://api.example.com/users"
/behavior:workspace:postman --action create --target request --spec "--method POST --url https://api.example.com/users --body '{\"name\":\"test\"}'"
/behavior:workspace:postman --action read --target collection
/behavior:workspace:postman --action read --target collection --id my-collection-id
/behavior:workspace:postman --action update --target request --id req-id --spec "--body '{\"name\":\"updated\"}'"
/behavior:workspace:postman --action delete --target request --id req-id
```
