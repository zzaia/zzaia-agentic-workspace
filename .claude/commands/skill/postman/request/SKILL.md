...
sequenceDiagram
    ...
    U->>C: /skill:postman:request --spec <payload>
...
```
/skill:postman:request --spec '{"method":"GET","url":"https://api.example.com/data","headers":{"Authorization":"Bearer token"}}'
```

```
/skill:postman:request --spec '{"method":"POST","url":"https://api.example.com/data","headers":{"Content-Type":"application/json"},"body":{"name":"test"}}' --description "Create new user in test environment"
```
