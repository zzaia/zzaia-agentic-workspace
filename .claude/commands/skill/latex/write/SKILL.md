...
sequenceDiagram
    ...
    U->>C: /skill:latex:write --template <path> --output <path> [--data <json>]
...
```
/skill:latex:write --template ./templates/document.tex.j2 --output ~/report.pdf --data '{"title":"My Report","author":"John Doe"}'
/skill:latex:write --template /absolute/path/template.tex.j2 --output ./output/document.pdf
```
