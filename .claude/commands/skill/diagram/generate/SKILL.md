...
sequenceDiagram
    ...
    U->>C: /skill:diagram:generate --code <code> --output <path>
...
```
/skill:diagram:generate --code "graph TD\n A --> B --> C" --output ./diagrams/flow.png
/skill:diagram:generate --code "sequenceDiagram\n  A->>B: Hello" --output ./diagrams/seq.png
/skill:diagram:generate --type graphviz --code "digraph { A -> B -> C }" --output ./diagrams/arch.png
```
