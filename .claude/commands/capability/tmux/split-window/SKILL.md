...
sequenceDiagram
    ...
    U->>C: /capability:tmux:split-window --name dev --direction vertical
...
```
/capability:tmux:split-window --name dev
/capability:tmux:split-window --name dev --direction vertical
/capability:tmux:split-window --name dev --window 0 --direction horizontal
/capability:tmux:split-window --name build --description "splitting window for parallel builds"
```
