...
sequenceDiagram
    ...
    U->>C: /capability:tmux:attach --name dev
...
```
/capability:tmux:attach --name dev
/capability:tmux:attach --name 0
/capability:tmux:attach --name build --description "reconnecting to build session"
```
