...
sequenceDiagram
    ...
    U->>C: /capability:tmux:new --name dev --dir /repo
...
```
/capability:tmux:new --name dev
/capability:tmux:new --name build --dir /workspace/project
/capability:tmux:new --name api --window server --dir /app
/capability:tmux:new --name monitor --description "monitoring session for health checks"
```
