...
|----------------|----------------------------------------------------|----------------------------------------------------------|
| `new`          | [@capability:tmux:new](./new/SKILL.md)                 | Create a new named tmux session                          |
| `list`         | [@capability:tmux:list](./list/SKILL.md)               | List all active tmux sessions with status               |
| `attach`       | [@capability:tmux:attach](./attach/SKILL.md)           | Attach to an existing tmux session                      |
| `split-window` | [@capability:tmux:split-window](./split-window/SKILL.md) | Split a tmux window horizontally or vertically         |
| `send-keys`    | [@capability:tmux:send-keys](./send-keys/SKILL.md)     | Send keystrokes or commands to a target pane           |
| `kill-session` | [@capability:tmux:kill-session](./kill-session/SKILL.md) | Kill tmux sessions by name                             |
