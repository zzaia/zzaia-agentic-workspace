...
|------------|-----------------------------------------------|--------------------------------------------------------------------------|
| `debug`    | [@capability:playwright:debug](./debug/SKILL.md)   | Collect console logs, network errors, and snapshots; generate issue report |
| `navigate` | [@capability:playwright:navigate](./navigate/SKILL.md) | Navigate to a URL and interact with the page via Playwright MCP          |
