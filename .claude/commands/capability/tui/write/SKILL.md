...
sequenceDiagram
    ...
    U->>C: /capability:tui:write --type <type> --message <msg>
...
```
/capability:tui:write --type info --message "Starting deployment"
/capability:tui:write --type success --message "Build completed successfully"
/capability:tui:write --type error --message "Connection timeout after 30s"
/capability:tui:write --type agent --message "Invoking code-reviewer agent"
/capability:tui:write --type markdown --message "# Heading\n\nSome **bold** text"
```
