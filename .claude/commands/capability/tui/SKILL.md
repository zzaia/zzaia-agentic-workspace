...
|---------|--------------------------------|----------------------------------------------|
| `open`  | [@capability:tui:open](./open/SKILL.md)   | Start TUI server in a new tmux split pane    |
| `close` | [@capability:tui:close](./close/SKILL.md) | Gracefully shutdown the running TUI          |
| `write` | [@capability:tui:write](./write/SKILL.md) | Send a structured event to the TUI           |
| `read`  | [@capability:tui:read](./read/SKILL.md)   | Read the last N log lines from the TUI       |
