...
|---------|-------------------------------------|--------------------------------------------------|
| `read`  | [@capability:document:read](./read/SKILL.md)   | Extract text from PDF/Word files into context    |
| `write` | [@capability:document:write](./write/SKILL.md) | Generate and deliver markdown documents          |
| `scrap` | [@capability:document:scrap](./scrap/SKILL.md) | Discover and download documents from web sources |
