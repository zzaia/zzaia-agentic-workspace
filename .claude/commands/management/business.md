...
sequenceDiagram
    ...
    U->>C: /management:business --context "..."
...
```
/management:business --context "Multi-tenant notification service with email, SMS, and push channels"

/management:business --work-directory ./workspace/payments.worktrees/master

/management:business --context "Refactor payment gateway integration to support new providers"

/management:business --context "SaaS subscription management with tiering, upgrades, downgrades, and cancellation"
```
