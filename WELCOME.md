...
→ Definition: [behavior/workspace/repo.md](agents/claude/.claude/commands/behavior/workspace/repo.md)
...
→ Definition: [workflow/remote/architect.md](agents/claude/.claude/commands/workflow/remote/architect.md)
...
→ Definition: [workflow/remote/implement.md](agents/claude/.claude/commands/workflow/remote/implement.md)
...
|---------|---------|------------|
| `/behavior:ask <question>` | Ask anything about the codebase or architecture | [ask.md](agents/claude/.claude/commands/behavior/ask.md) |
| `/behavior:devops:work-item` | Read and manage Azure DevOps work items | [work-item.md](agents/claude/.claude/commands/behavior/devops/work-item.md) |
| `/workflow:remote:fix-pipeline` | Diagnose and repair failing pipelines | [fix-pipeline.md](agents/claude/.claude/commands/workflow/remote/fix-pipeline.md) |
| `/workflow:remote:homologate` | Run homologation tests before release | [homologate.md](agents/claude/.claude/commands/workflow/remote/homologate.md) |
| `/behavior:workspace:apphost --action setup` | Configure Aspire AppHost with workspace services | [apphost.md](agents/claude/.claude/commands/behavior/workspace/apphost.md) |
...
- [CLAUDE.md](agents/claude/CLAUDE.md) — command hierarchy, agent structure, development standards
